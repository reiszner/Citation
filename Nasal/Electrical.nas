...
var gen1_start            = props.globals.getNode("controls/electric/engine[0]/starter",0);
...
var gen2_start            = props.globals.getNode("controls/electric/engine[1]/starter",0);
...
### special for ignition lights
    if (getprop("controls/electric/engine[0]/starter") and getprop("/controls/electric/circuit-breakers/isolated-left/cb-light-start-left")) {
        setprop("systems/electrical/outputs/isolated-left/light-start-left", batt_hot);
    }
    if (getprop("controls/electric/engine[1]/starter") and getprop("/controls/electric/circuit-breakers/isolated-right/cb-light-start-right")) {
